...
export default function SocialSection() {
    const items = [
        {
            ...
            title: "Discord",
            description:
                "Bergabung ke komunitas Discord kami untuk dukungan, chat real-time, dan event lainnya.",
        ...
        },
        {
            ...
            title: "TikTok",
            description:
                "Ikuti TikTok kami untuk klip menarik, tutorial, dan live server.",
            buttonText: "Buka Tautan",
            link: "/tiktok",
        },
        {
            ...
            title: "WhatsApp",
            description:
                "Subscribe to our WhatsApp channel for instant notifications and important announcements.",
            buttonText: "Buka Tautan",
            link: "/whatsapp",
        },
    ]
    ...
    return (
        <section className="w-full bg-gray-900 py-20" id="social">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    <h2 className="text-4xl font-bold text-white mb-4">Gabung dengan Komunitas Kami</h2>
                        ...
                        >
                            <CardHeader className="p-0 mb-6">
                                <div className="flex items-center space-x-4">
                                    ...
                                    <CardTitle
                                        className="text-white text-2xl font-bold">{item.title}</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="p-0 flex flex-col flex-grow">
                                <p className="text-gray-300 mb-8 text-base leading-relaxed flex-grow">{item.description}</p>
                                <Button
                                    asChild
